...
namespace Localization.JsonLocalizer.StringLocalizer
{
	public class JsonStringLocalizerFactory : IStringLocalizerFactory
	{
										  ...
										  ILogger<JsonStringLocalizerFactory> logger)
		{
			...
			logger.LogInformation($"Created {nameof(JsonStringLocalizerFactory)} with:{Environment.NewLine}" +
		...
		public IStringLocalizer Create(Type resourceSource)
		{
			...
			_logger.LogInformation($"Getting localizer for type {resourceSource}");
			...
			_logger.LogInformation($"Localizer basename: {resourceBaseName}");
		...
		public IStringLocalizer Create(string baseName, string location)
		{
			...
			_logger.LogInformation($"Getting localizer for baseName {baseName} and location {location}");
