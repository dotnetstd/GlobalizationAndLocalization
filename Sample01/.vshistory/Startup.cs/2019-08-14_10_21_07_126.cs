...
namespace Sample01
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //services.Replace(ServiceDescriptor.Singleton<ILocalizationFileLocationProvider, MyLIModularPoFileLocationProvider>());
            ...
            services.AddInMemoryLocalization(new List<MainApp.Models.Localization.Resource>
            {
                new MainApp.Models.Localization.Resource("en-US", "Hello", "Hello"),
                new MainApp.Models.Localization.Resource("fr-FR", "Hello", "Bonjour"),
            });
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            //Cultures Dynamically at Runtime From JSON Files
            //var optionss = new RequestLocalizationOptions();
            //optionss.RequestCultureProviders.Insert(0, new JsonRequestCultureProvider());
            //app.UseRequestLocalization(optionss).WithDynamicCultures();


            //New Version 2.1
            //Allow setting RootNamespace in ResourceLocationAttribute
            //var supportedCulturesss = new[] { "en-US", "en-AU", "fr-FR" };
            //app.UseRequestLocalization(optionsss =>
            //    optionsss
            //        .AddSupportedCultures(supportedCulturesss)
            //        .AddSupportedUICultures(supportedCulturesss)
            //        .SetDefaultCulture(supportedCulturesss[0])
            //);
            //Or
