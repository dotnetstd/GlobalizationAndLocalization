...
namespace My.Extensions.Localization.Json
{
    public class JsonStringLocalizerFactory : IStringLocalizerFactory
    {
        ...
        protected virtual JsonStringLocalizer CreateJsonStringLocalizer(string resourcesPath, string resourcename) => new JsonStringLocalizer(resourcesPath, resourcename, _loggerFactory.CreateLogger<JsonStringLocalizer>());
