...
namespace Localization.MvcTest
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddXmlLocalization(options => { options.CacheDependency = CacheOption.IDistributedCache; });

            //Configuring Json Localizarion
            services.AddJsonLocalization(options => { options.CacheDependency = CacheOption.IDistributedCache; });
