...
using LocalizedRoutes.Examples;
...
#error Target framework needs to be updated
            ...
            var routeLocalizer = new JsonRoutesLocalizerExample(Configuration["Culture"], Configuration["Theme"]);
            ...
            services.Configure<RouteOptions>(options =>
            {
                ...
                options.ConstraintMap.Add("lang", typeof(LanguageRouteConstraint2));
            });
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, IStringLocalizer<Startup> startupStringLocalizer, IStringLocalizerFactory localizerFactory)
        {
