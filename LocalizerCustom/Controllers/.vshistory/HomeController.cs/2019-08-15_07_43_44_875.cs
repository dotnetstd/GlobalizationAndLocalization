...
namespace LocalizerCustom.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public ActionResult Edit(Planet planett, LocalizedContent[] namee)
        {
            ...
            planett.Set(i => i.Name, namee);

            //Single Object
            //var planet1 = _db.Planets.SingleOrDefault(i => i.Id == 1).Localize("fa");

            //Localizing a Collection
            //var planets2 = _db.Planets.Localize<Planet>("fa");

            //Localizing Specific Properties
            //var planets3 = _db.Planets.Localize("fa", i => i.Name);
        ...
        [LocalizedRoute("how-it-works", Name = "how")]
        //{"how":"hur-det-fungerar"} Json File
        [Route("hur-det-fungerar")]
        [LocalizedRoute("<account>/{id:int}/<details>", Name = "<how>")]
        //{"<how>":"<konto>,<detaljer>"} Json File
        ...
        public IActionResult IndexRouting() => View();
